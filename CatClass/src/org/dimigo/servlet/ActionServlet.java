...
import org.dimigo.action.Cat_ShoppingAction;
import org.dimigo.action.Cat_SignupAction;
...
public class ActionServlet extends HttpServlet {
	...
	public void init() throws ServletException {
		...
		actions.put("cat_signup", new Cat_SignupAction());
		actions.put("cat_shopping", new Cat_ShoppingAction());
	}
